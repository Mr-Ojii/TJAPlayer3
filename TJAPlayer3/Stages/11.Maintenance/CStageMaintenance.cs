    ...
    class CStageMaintenance : CStage
    {
		...
		public override void OnManagedリソースの作成()
		{
			if (!base.b活性化してない)
			{
				...
				{
					str[ind] = TJAPlayer3.tCreateTexture(new CPrivateFastFont(TJAPlayer3.ConfigIni.FontName, fontsize).DrawPrivateFont(txt[ind], Color.White, Color.Black, TJAPlayer3.Skin.Font_Edge_Ratio));
				}
