...
internal class CActMtaiko : CActivity
{
    ...
    public override int On進行描画()
    {
        ...
        for (int i = 0; i < TJAPlayer3.app.ConfigToml.PlayOption.PlayerCount; i++)
            TJAPlayer3.Tx.Taiko_Background[i]?.t2D描画(TJAPlayer3.app.Device, TJAPlayer3.app.Skin.SkinConfig.Game.Taiko.BackGroundX[i], TJAPlayer3.app.Skin.SkinConfig.Game.Taiko.BackGroundY[i]);

        for (int i = 0; i < TJAPlayer3.app.ConfigToml.PlayOption.PlayerCount; i++)
            TJAPlayer3.Tx.Taiko_Base?.t2D描画(TJAPlayer3.app.Device, TJAPlayer3.app.Skin.SkinConfig.Game.Taiko.X[i], TJAPlayer3.app.Skin.SkinConfig.Game.Taiko.Y[i]);
        ...
        if (TJAPlayer3.Tx.Taiko_Don_Left != null && TJAPlayer3.Tx.Taiko_Don_Right != null && TJAPlayer3.Tx.Taiko_Ka_Left != null && TJAPlayer3.Tx.Taiko_Ka_Right != null)
        {
            ...
            TJAPlayer3.Tx.Taiko_Ka_Left.t2D描画(TJAPlayer3.app.Device, TJAPlayer3.app.Skin.SkinConfig.Game.Taiko.X[0], TJAPlayer3.app.Skin.SkinConfig.Game.Taiko.Y[0], new Rectangle(0, 0, TJAPlayer3.Tx.Taiko_Ka_Right.szTextureSize.Width / 2, TJAPlayer3.Tx.Taiko_Ka_Right.szTextureSize.Height));
            TJAPlayer3.Tx.Taiko_Ka_Right.t2D描画(TJAPlayer3.app.Device, TJAPlayer3.app.Skin.SkinConfig.Game.Taiko.X[0] + TJAPlayer3.Tx.Taiko_Ka_Right.szTextureSize.Width / 2, TJAPlayer3.app.Skin.SkinConfig.Game.Taiko.Y[0], new Rectangle(TJAPlayer3.Tx.Taiko_Ka_Right.szTextureSize.Width / 2, 0, TJAPlayer3.Tx.Taiko_Ka_Right.szTextureSize.Width / 2, TJAPlayer3.Tx.Taiko_Ka_Right.szTextureSize.Height));
            TJAPlayer3.Tx.Taiko_Don_Left.t2D描画(TJAPlayer3.app.Device, TJAPlayer3.app.Skin.SkinConfig.Game.Taiko.X[0], TJAPlayer3.app.Skin.SkinConfig.Game.Taiko.Y[0], new Rectangle(0, 0, TJAPlayer3.Tx.Taiko_Ka_Right.szTextureSize.Width / 2, TJAPlayer3.Tx.Taiko_Ka_Right.szTextureSize.Height));
            TJAPlayer3.Tx.Taiko_Don_Right.t2D描画(TJAPlayer3.app.Device, TJAPlayer3.app.Skin.SkinConfig.Game.Taiko.X[0] + TJAPlayer3.Tx.Taiko_Ka_Right.szTextureSize.Width / 2, TJAPlayer3.app.Skin.SkinConfig.Game.Taiko.Y[0], new Rectangle(TJAPlayer3.Tx.Taiko_Ka_Right.szTextureSize.Width / 2, 0, TJAPlayer3.Tx.Taiko_Ka_Right.szTextureSize.Width / 2, TJAPlayer3.Tx.Taiko_Ka_Right.szTextureSize.Height));
        }
        ...
        if (TJAPlayer3.Tx.Taiko_Don_Left != null && TJAPlayer3.Tx.Taiko_Don_Right != null && TJAPlayer3.Tx.Taiko_Ka_Left != null && TJAPlayer3.Tx.Taiko_Ka_Right != null)
        {
            ...
            TJAPlayer3.Tx.Taiko_Ka_Left.t2D描画(TJAPlayer3.app.Device, TJAPlayer3.app.Skin.SkinConfig.Game.Taiko.X[1], TJAPlayer3.app.Skin.SkinConfig.Game.Taiko.Y[1], new Rectangle(0, 0, TJAPlayer3.Tx.Taiko_Ka_Right.szTextureSize.Width / 2, TJAPlayer3.Tx.Taiko_Ka_Right.szTextureSize.Height));
            TJAPlayer3.Tx.Taiko_Ka_Right.t2D描画(TJAPlayer3.app.Device, TJAPlayer3.app.Skin.SkinConfig.Game.Taiko.X[1] + TJAPlayer3.Tx.Taiko_Ka_Right.szTextureSize.Width / 2, TJAPlayer3.app.Skin.SkinConfig.Game.Taiko.Y[1], new Rectangle(TJAPlayer3.Tx.Taiko_Ka_Right.szTextureSize.Width / 2, 0, TJAPlayer3.Tx.Taiko_Ka_Right.szTextureSize.Width / 2, TJAPlayer3.Tx.Taiko_Ka_Right.szTextureSize.Height));
            TJAPlayer3.Tx.Taiko_Don_Left.t2D描画(TJAPlayer3.app.Device, TJAPlayer3.app.Skin.SkinConfig.Game.Taiko.X[1], TJAPlayer3.app.Skin.SkinConfig.Game.Taiko.Y[1], new Rectangle(0, 0, TJAPlayer3.Tx.Taiko_Ka_Right.szTextureSize.Width / 2, TJAPlayer3.Tx.Taiko_Ka_Right.szTextureSize.Height));
            TJAPlayer3.Tx.Taiko_Don_Right.t2D描画(TJAPlayer3.app.Device, TJAPlayer3.app.Skin.SkinConfig.Game.Taiko.X[1] + TJAPlayer3.Tx.Taiko_Ka_Right.szTextureSize.Width / 2, TJAPlayer3.app.Skin.SkinConfig.Game.Taiko.Y[1], new Rectangle(TJAPlayer3.Tx.Taiko_Ka_Right.szTextureSize.Width / 2, 0, TJAPlayer3.Tx.Taiko_Ka_Right.szTextureSize.Width / 2, TJAPlayer3.Tx.Taiko_Ka_Right.szTextureSize.Height));
        }
        ...
        for (int i = 0; i < TJAPlayer3.app.ConfigToml.PlayOption.PlayerCount; i++)
        {
            ...
            if ((this.ctレベルアップダウン[i].b進行中 && (TJAPlayer3.Tx.Taiko_LevelUp != null && TJAPlayer3.Tx.Taiko_LevelDown != null)) && !TJAPlayer3.app.ConfigToml.Game.NoInfo)
            {
                ...
                if (this.After[i] - this.Before[i] >= 0)
                {
                    ...
                    TJAPlayer3.Tx.Taiko_LevelUp.t2D拡大率考慮描画(TJAPlayer3.app.Device, CTexture.RefPnt.Center, -329 + TJAPlayer3.app.LogicalSize.Width / 2, fY[i] + TJAPlayer3.app.LogicalSize.Height / 2);
                }
                else
                {
                    TJAPlayer3.Tx.Taiko_LevelDown.Opacity = nAlpha;
                    TJAPlayer3.Tx.Taiko_LevelDown.vcScaling = new Vector2(fScale, fScale);
                    TJAPlayer3.Tx.Taiko_LevelDown.t2D拡大率考慮描画(TJAPlayer3.app.Device, CTexture.RefPnt.Center, -329 + TJAPlayer3.app.LogicalSize.Width / 2, fY[i] + TJAPlayer3.app.LogicalSize.Height / 2);
                }
            }
        }
        ...
        for (int nPlayer = 0; nPlayer < TJAPlayer3.app.ConfigToml.PlayOption.PlayerCount; nPlayer++)
        {
            ...
            {
                TJAPlayer3.Tx.Taiko_NamePlate[nPlayer].t2D描画(TJAPlayer3.app.Device, TJAPlayer3.app.Skin.SkinConfig.Game.Taiko.NamePlateX[nPlayer], TJAPlayer3.app.Skin.SkinConfig.Game.Taiko.NamePlateY[nPlayer]);
            }

            if (TJAPlayer3.Tx.Taiko_PlayerNumber[nPlayer] != null)
            {
                TJAPlayer3.Tx.Taiko_PlayerNumber[nPlayer].t2D描画(TJAPlayer3.app.Device, TJAPlayer3.app.Skin.SkinConfig.Game.Taiko.PlayerNumberX[nPlayer], TJAPlayer3.app.Skin.SkinConfig.Game.Taiko.PlayerNumberY[nPlayer]);
            }
        }
