...
internal class CActDancer : CActivity
{
    ...
    public override int On進行描画()
    {
        ...
        if (this.ct踊り子モーション != null || TJAPlayer3.app.Skin.Game_Dancer_Ptn != 0) this.ct踊り子モーション.t進行LoopDb();

        if (TJAPlayer3.app.ConfigToml.Game.ShowDancer && this.ct踊り子モーション != null && TJAPlayer3.app.Skin.Game_Dancer_Ptn != 0)
        {
