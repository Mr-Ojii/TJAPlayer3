	...
	public override int On進行描画()
	{
		...
		if (TJAPlayer3.ConfigIni.bEnableSkinV2)
		{
			...
			for (int i = 0; i < TJAPlayer3.ConfigIni.nPlayerCount; i++)
			{
				...
				this.t小文字表示V2(TJAPlayer3.Skin.SkinConfig.Result.v2BadX[i], TJAPlayer3.Skin.SkinConfig.Result.v2BadY[i], TJAPlayer3.stageResult.st演奏記録[i].nMiss数, false, EPhaseV2.Bad, i);
		...
		else
		{
			...
			for (int i = 0; i < TJAPlayer3.ConfigIni.nPlayerCount; i++)
			{
				...
				this.t小文字表示(TJAPlayer3.Skin.SkinConfig.Result.BadX[i], TJAPlayer3.Skin.SkinConfig.Result.BadY[i], TJAPlayer3.stageResult.st演奏記録[i].nMiss数, false, EPhase.Bad, i);
