...
internal class CStageEnding : CStage
{
    ...
    {
        if ((EEndingAnime)TJAPlayer3.app.ConfigToml.Ending.EndingAnime == EEndingAnime.Off || (this.ctAnimation is null) || (TJAPlayer3.InputManager.Keyboard.bIsKeyPressed((int)SlimDXKeys.Key.Escape))) //2017.01.27 DD
        {
            return 1;
        }
        if (!base.b活性化してない)
