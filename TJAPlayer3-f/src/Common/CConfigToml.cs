...
public class CConfigToml 
{
    ...
    public void Save(string FilePath)
    {
        using(StreamWriter sw = new StreamWriter(FilePath, false))
        {
            ...
            sw.WriteLine("{0} = {1}", nameof(this.Window.FullScreen), this.Window.FullScreen.ToString().ToLower());
            sw.WriteLine();
            ...
            sw.WriteLine("{0} = {1}", nameof(this.Log.SongSearch), this.Log.SongSearch.ToString().ToLower());
            sw.WriteLine();
            sw.WriteLine("# 画像やサウンドの作成_解放に関するLog出力");
            sw.WriteLine("{0} = {1}", nameof(this.Log.CreatedDisposed), this.Log.CreatedDisposed.ToString().ToLower());
            sw.WriteLine();
            sw.WriteLine("# 譜面読み込み詳細に関するLog出力");
            sw.WriteLine("{0} = {1}", nameof(this.Log.ChartDetails), this.Log.ChartDetails.ToString().ToLower());
            sw.WriteLine();
            ...
            sw.WriteLine("{0} = {1}", nameof(this.SongSelect.RandomPresence), this.SongSelect.RandomPresence.ToString().ToLower());
            sw.WriteLine();
            ...
            sw.WriteLine("{0} = {1}", nameof(this.SongSelect.CountDownTimer), this.SongSelect.CountDownTimer.ToString().ToLower());
            sw.WriteLine();
            sw.WriteLine("# TCC風");
            sw.WriteLine("# Enable TCC-like style.");
            sw.WriteLine("{0} = {1}", nameof(this.SongSelect.TCCLikeStyle), this.SongSelect.TCCLikeStyle.ToString().ToLower());
            sw.WriteLine();
            sw.WriteLine("# 選曲画面でのMouseホイールの有効化");
            sw.WriteLine("# Enable mousewheel in songselect.");
            sw.WriteLine("{0} = {1}", nameof(this.SongSelect.EnableMouseWheel), this.SongSelect.EnableMouseWheel.ToString().ToLower());
            sw.WriteLine();
            ...
            sw.WriteLine("{0} = {1}", nameof(this.Game.ShowChara), this.Game.ShowChara.ToString().ToLower());
            sw.WriteLine("# ダンサー画像を表示する");
            sw.WriteLine("{0} = {1}", nameof(this.Game.ShowDancer), this.Game.ShowDancer.ToString().ToLower());
            sw.WriteLine("# ランナー画像を表示する");
            sw.WriteLine("{0} = {1}", nameof(this.Game.ShowRunner), this.Game.ShowRunner.ToString().ToLower());
            sw.WriteLine("# モブ画像を表示する");
            sw.WriteLine("{0} = {1}", nameof(this.Game.ShowMob), this.Game.ShowMob.ToString().ToLower());
            sw.WriteLine("# フッター画像");
            sw.WriteLine("{0} = {1}", nameof(this.Game.ShowFooter), this.Game.ShowFooter.ToString().ToLower());
            sw.WriteLine("# ぷちキャラ画像");
            sw.WriteLine("{0} = {1}", nameof(this.Game.ShowPuchiChara), this.Game.ShowPuchiChara.ToString().ToLower());
            sw.WriteLine();
            ...
            sw.WriteLine("{0} = {1}", nameof(this.Game.BigNotesJudgeFrame), this.Game.BigNotesJudgeFrame.ToString().ToLower());
            sw.WriteLine();
            ...
            sw.WriteLine("{0} = {1}", nameof(this.PlayOption.BGMSound), this.PlayOption.BGMSound.ToString().ToLower());
            sw.WriteLine();
            ...
            sw.WriteLine("{0} = {1}", nameof(this.PlayOption.AutoRoll), this.PlayOption.AutoRoll.ToString().ToLower());
            sw.WriteLine();
